    ...
    <!-- Example row of columns -->
     <div class="row">
        <div class="col-md-4">
            ...
            <A href="https://aws.amazon.com/devops/what-is-devops/" ID="image1">View details.</A>
        </div>
    </div>
    <div class="row">
        <div class="col-md-4">
            ...
            <A href="https://www.jenkins.io/" ID="image1">View details.</A>
        </div>
        <div class="col-md-4">
            <h2>Maven</h2>
            ...
            <A href="https://maven.apache.org/what-is-maven.html" ID="image1">View details.</A>
        </div>
        <div class="col-md-4">
            <h2>Docker</h2>
